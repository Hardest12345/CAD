...
<head>
    ...
    <title>Chatbot Kampung Wisata Keramik Dinoyo</title>
...
<body>
    ...
    <main class="paket">
        <h1>Pilihan Paket Wisata Premium Ceramic Art Dinoyo</h1>
        <div class="packages">
            <div class="package package1">
                <h2>Paket Wisata Premium 1</h2>
                <p>Dapatkan benefit lengkap dengan paket premium 1</p>
                <h3>IDR 99k</h3>
                <button onclick="pilihPaket('Paket A')">Gass!!!</button>
                <ul>
                    <li><span>✓</span> Melihat proses produksi</li>
                    <li><span>✓</span> Membentuk keramik (Dibakar dan dibawa pulang)</li>
                    <li><span>✓</span> Kunjungan ke industri keramik dinoyo</li>
                    <li><span>✓</span> Melukis keramik (Dibawa pulang)</li>
                </ul>
            </div>
            <div class="package package2">
                <h2>Paket Premium 2</h2>
                <p>Dapatkan beberapa benefit dengan harga lebih murah</p>
                <h3>IDR 59k</h3>
                <button onclick="pilihPaket('Paket B')">Gass!!!</button>
                <ul>
                    <li><span>✓</span>Kunjungan ke industri keramik dinoyo</li>
                    <li><span>✓</span>Melihat proses produksi</li>
                    <li><span>✓</span>Hanya bisa memilih salah satu (Melukis atau Membentuk) Hasil dibawa pulang</li>
                </ul>
            </div>
        </div>
    </main>
    ...
    <script>
        function pilihPaket(paket) {
            // Menyimpan jenis paket yang dipilih ke localStorage
            localStorage.setItem('jenis_paket', paket);
            // Mengarahkan ke halaman booking
            window.location.href = '/booking_test/booking_form.php';
        }
    </script>
</body>
</html>
